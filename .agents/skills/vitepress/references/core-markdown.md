...
```md
::: danger STOP Do not proceed! :::

::: details Click me {open} Open by default with {open} attribute. :::
```
...
```md
> [!NOTE] Highlights information users should know.

> [!TIP] Optional information for success.
...
<<< @/snippets/config.js <<< @/snippets/config.ts

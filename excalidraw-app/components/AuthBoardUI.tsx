...
export const AuthBoardUI = ({
  ...
  if (!session) {
    return (
      <section className={styles.panel} aria-labelledby="auth-board-title">
        <h1 id="auth-board-title" className={styles.title}>
          Tus pizarras
        </h1>
  ...
  return (
    <section className={styles.panel} aria-labelledby="boards-title">
      <h1 id="boards-title" className={styles.title}>
        Tus pizarras
      </h1>

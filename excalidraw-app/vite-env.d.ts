...
interface ImportMetaEnv {
  ...
  // Cloudinary unsigned-upload config, used for shareable link and
  // collaboration image storage (no backend of our own required)
  VITE_APP_CLOUDINARY_CLOUD_NAME: string;
  VITE_APP_CLOUDINARY_UPLOAD_PRESET: string;
